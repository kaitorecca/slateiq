...
class Take:
    ...
    def take_id(self) -> str:
        ...
        return (
            f"TOS-D{DAY_NUMBER:02d}-S{self.scene_number}-{self.shot}-"
...
TAKES: list[Take] = [
    ...
    Take(
        ...
        parent="TOS-D12-S12-A-01-A",
        degrade="soft_focus",
        defect_window=(4.5, 9.5),
    ),
    Take(
        "12",
        "B",
    ...
    Take(
        ...
        parent="TOS-D12-S14A-A-01-A",
        degrade="boom_in_shot",
        defect_window=(7.0, 8.6),
    ),
    Take(
        "14A",
        "B",
    ...
    Take(
        ...
        parent="TOS-D12-S27-A-01-A",
        degrade="audio_clip",
        defect_window=(5.0, 8.5),
    ),
    Take(
        "27",
        "B",
        ...
        "14:33:05:11",
        "hold",
        "Wide, usable if we need the geography.",
        src_start=172.29,
        src_end=183.25,
    ),
    # ---- scene 33 -------------------------------------------------------
    ...
    Take(
        ...
        parent="TOS-D12-S33-A-01-A",
        degrade="frame_edge",
        defect_window=(3.0, 7.0),
    ),
    Take(
        "33",
        "B",
    ...
    Take(
        ...
        parent="TOS-D12-S41-A-01-A",
        degrade="soft_focus",
        defect_window=(3.5, 9.0),
    ),
    Take(
        "41",
        "B",
    ...
    Take(
        ...
        parent="TOS-D12-S56-B-01-B",
        degrade="boom_in_shot",
        defect_window=(3.0, 4.8),
    ),
    # ---- scene 78 -------------------------------------------------------
    Take(
        "78",
