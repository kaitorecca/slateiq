...
**`slateiq-00010-6vb`** — hosted URLs only, no local stack.
...
| Video | ≤ 3 min, YouTube/Vimeo public, English | ⚠️ **shot and committed, NOT uploaded** — `video/slateiq_trailer_720p.mp4`. **The only genuine hole left in the package**; needs a human to publish it and paste the URL into README, `docs/DEVPOST.md`, this file and the Devpost form | video/slateiq_trailer_720p.mp4 |
